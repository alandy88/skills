...
> **Status:** the Codex deferral is superseded by [0003](./0003-ship-a-native-codex-plugin.md) — Codex now accepts `skills` as an array, so the plugin ships. The Claude Code decision below stands.
