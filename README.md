...
- **[grill-with-docs-headless](./skills/engineering/grill-with-docs-headless/SKILL.md)** — Autonomous variant of grill-with-docs: runs the whole grilling pass unattended, resolving each decision branch itself with confidence scores and emitting a Session Ledger report.
...
- **[to-tickets](./skills/engineering/to-tickets/SKILL.md)** — Break a plan, spec, or conversation into tracer-bullet tickets with blocking edges; on real trackers, group 3 or more under an epic.
