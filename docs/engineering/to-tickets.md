...
| A real tracker (GitHub, Linear) | Native blocking links, or sub-issues where the tracker has them; 3 or more tickets are grouped under an unlabeled epic as native sub-issues | Any ticket whose blockers are done is on the **frontier** and can be grabbed |
